...
from greenguide_common.imaging import IMAGE_CHANNELS, IMAGE_SIZE  # noqa: F401 — 하위호환 re-export
...
# 자매 프로젝트인 greenguide-preprocessor의 산출물을 직접 참조
...
# 계층 학습의 정본은 greenguide_common.taxonomy (대분류 14 × 세부 25) 이며 이 목록과 무관.
...
# 입력 차원 — IMAGE_SIZE/IMAGE_CHANNELS 는 greenguide_common.imaging 과 공유 (preprocessor 의 VECTOR_DIM 과 동일 출처)
