"""파이프라인 전역 설정 — 경로 상수는 여기, 공통값(이미지·Supabase)은 waste_common 에서 가져온다."""
from __future__ import annotations

from pathlib import Path

from waste_common import settings
from waste_common.imaging import (  # noqa: F401 — 하위호환 re-export
    IMAGE_CHANNELS,
    IMAGE_SIZE,
    IMAGENET_MEAN,
    IMAGENET_STD,
...
# 현행 분류체계 정본은 waste_common.taxonomy 이며, catalog 는 폴더 auto-discover 로 실제 클래스를 결정한다.
