/// 대한민국 행정구역 (시도 → 시군구) 정적 목록 — 지역 선택 UI 용.
///
/// 행정구역 개편은 드물어 정적 포함이 안전 (2026 기준 17개 시도).
/// 배출 규정 데이터 자체는 서버(/region-info)가 공공데이터 기준으로 제공.
const Map<String, List<String>> kKoreaRegions = {
  '서울특별시': [
